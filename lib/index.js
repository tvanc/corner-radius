// The paint API doesn't expose enough information for me to construct
// a path that encompasses all children
...
function getDrawCommands(el) {
  ...
  const outlines = getOutlines(rectangles)

  console.log("All paths", rectangles)
  console.log("collapsed path", collapsedPaths)
}

function getOutlines(rectangles) {
  // generate a sequence of points going clockwise from top left
  // for (const [index, path] of rectangles) {
  //
  // }
