...
import { edgesMatch, getEdges, getPolygons } from "../getPolygons"
...
test("getPolygons()", function () {
  ...
  //       │  2  │
  // 200 — └─────┘
  rectangles[0] = new Rectangle(new Point(0, 0), new Point(100, 100))
  rectangles[1] = new Rectangle(new Point(100, 0), new Point(200, 100))
  rectangles[2] = new Rectangle(new Point(0, 100), new Point(100, 200))

  const uniqueEdges = getPolygons(rectangles)
